...
const MovieDetails = () => {
  ...
  return show ? (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-40'>
      ...
      rounded-xl h-[400px] max-w-70 object-cover'/>

      <div className='relative flex flex-col gap-3'>
        <BlurCircle top='-100px' left='-100px'/>
        <p className='text-indigo-700'>ENGLISH</p>
      ...
      <div className='flex items-center flex-wrap gap-4 mt-4'>
        ...
        <a href="#dateSelect" className='px-10 py-3  text-sm bg-indigo-700 hover:bg-indigo-800 transition rounded-md font-medium cursor-pointer active:scale-95'>Buy Tickets</a>
      ...
      <p className='text-lg font-medium mt-20 mb-8'>You May Also Like</p>
        ...
        <div className='flex justify-center mt-20'>
          ...
          className='px-10 py-3 text-sm bg-[#F84565] hover:bg-[#D63854] transition rounded-md 
